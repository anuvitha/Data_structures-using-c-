...
void reverse(){
	struct node *current=head,*next,*prev;
	if(head==NULL){
		cout<<"list is empty";
	}
...
int main(){
	...
	cout<<"4.deletion at first"<<endl<<"5.deletion at end"<<endl<<"6.deletion at position"<<endl<<"7.reverseing linked list"<<endl<<"8.exit"<<endl;
	do{
